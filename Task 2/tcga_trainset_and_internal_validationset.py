...
# Define directories
allTile = 'TCGA-LUAD/Extracted Tiles'
allEGFR = f'{allTile}/EGFR'
allKRAS = f'{allTile}/KRAS'
allSTK = f'{allTile}/STK11'

save_dir = 'TCGA-LUAD/Training'

if not os.path.exists(save_dir):
    os.mkdir(save_dir)

save_dir = 'TCGA-LUAD/Training/Training Set'
...
stain_ref = staintools.read_image('TCGA-LUAD/Stain Normalization Reference.png') # Reference image for stain normalization
...
# Save testing set (internal validation)
save_dir = 'TCGA-LUAD/Testing'

if not os.path.exists(save_dir):
    os.mkdir(save_dir)

save_dir = 'TCGA-LUAD/Testing/Testing Set'
