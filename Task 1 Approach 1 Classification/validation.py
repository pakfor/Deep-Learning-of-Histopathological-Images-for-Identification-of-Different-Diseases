...
mask_dir = 'E:/Camelyon16 Segmentation/Testing/Slide-level Segmentation Maps (512x downsampled)/NPY' # All masks should be in numpy array format
output_dir = 'E:/Camelyon16 Segmentation/Testing/Slide-level Segmentation Maps (512x downsampled)/Pixel Information (for validation)'
...
import_dir = 'E:/Camelyon16 Classification/Testing/Data (Test Set)/Stain Normalized (Tumor)'
model_dir = 'E:/Camelyon16 Classification/Trained Models/20220331_ResNet50_SN_Tr16000_Te4000_EP200_2CL_FP16_SGD/model_ckpt'
save_dir = 'E:/Camelyon16 Classification/Testing/Output/20220411/20220331_ResNet50_SN_Tr16000_Te4000_EP200_2CL_FP16_SGD_21TS'
gt_dir = 'E:/Camelyon16 Classification/Testing/Data (Test Set)/Mask (Ground Truth)/Slide-level Segmentation Maps (512x downsampled)/Pixel Information (for validation)'
gt_npy_dir = 'E:/Camelyon16 Classification/Testing/Data (Test Set)/Mask (Ground Truth)/Slide-level Segmentation Maps (512x downsampled)/NPY'
...
for case_i in tqdm(range(6,num_test_case)):
