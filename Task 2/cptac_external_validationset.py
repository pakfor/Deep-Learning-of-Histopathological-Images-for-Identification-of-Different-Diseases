...
ref_img = staintools.read_image('CPTAC-LUAD/Stain Normalization Reference.png')

gene_tile = pd.read_csv('CPTAC-LUAD/Data/Information/tumor_labels.txt',delimiter=' ',header=None,names=['gene','slide'])
save_selected_tile = 'CPTAC-LUAD/Training/Training Set (Sampled)'
original_path = 'CPTAC-LUAD/Training/Training Set'
...
datatype = 'float16'
allTile = 'CPTAC-LUAD/Testing/Testing Set (Sampled)'
