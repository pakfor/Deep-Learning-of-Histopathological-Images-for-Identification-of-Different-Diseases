...
model = tf.keras.models.load_model('E:/GradCAM/Trained Models/20220404_InceptionResNetV2_SN_Tr14400_Te3600_EP200_SGD_Binary_3CL_FP16/model_ckpt')
model.summary()

# CPTAC_LUAD
test_set = np.load(f'E:/GradCAM/Testing Sets/{test_set_name}/x_test.npy')
result_file = pd.read_csv(f'E:/GradCAM/Results/20220404_InceptionResNetV2_SN_Tr14400_Te3600_EP200_SGD_Binary_3CL_FP16_results_{test_set_name}.csv')
...
save_dir = f'E:/GradCAM/Output/20220404_InceptionResNetV2_SN_Tr14400_Te3600_EP200_SGD_Binary_3CL_FP16/{method}/{test_set_name}'

tissue_save_dir = f'E:/GradCAM/Output/20220404_InceptionResNetV2_SN_Tr14400_Te3600_EP200_SGD_Binary_3CL_FP16/Ground Truth/{test_set_name}'
