...
all_slide_dir = 'TCGA-LUAD/Data/Slides' # Directory storing all the slides of TCGA-LUAD
bg_tissue_mask_dir = 'TCGA-LUAD/Data/Tissue-BG Maps' # Directory storing the background-tissue map (binary)
slide_mutation_file = pd.read_excel('TCGA-LUAD/Data/Information/Mutation Distribution.xlsx') # Mutation information

tumor_slide_list = os.listdir(bg_tissue_mask_dir)
save_dir = 'TCGA-LUAD/Extracted Tiles'
